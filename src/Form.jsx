...
const Form = () => {
  ...
  function handleLogin() {
    if(formData.loginEmail === formData.signupEmail
      && formData.loginPassword === formData.signupPassword && formData.isShow) {
      ...
      { !formData.isLogin && <div>
        <form className="signup-form">
          ...
          <input
            ...
            value={formData.signupConfirmPassword} onChange = {handleFormData}
          />
        </form> 
        ...
        <form className="login-styles">
          ...
          value={formData.loginEmail} onChange = {handleFormData} />
          <label htmlFor="loginPassword">Password</label>
          <input id="loginPassword" name="loginPassword" type="password" 
          value={formData.loginPassword} onChange = {handleFormData} />
        </form>
